<template>
  <section>
    <div class="container-fluid p-0" id="gallery-wrapper">
      <div id="landing-gallery" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
          <button
            type="button"
            data-bs-target="#landing-gallery"
            data-bs-slide-to="0"
            class="active"
            aria-current="true"
            aria-label="Slide 1"
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="../assets/img/gallery/team1.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
          ...
          <div class="carousel-item">
            <img
              src="../assets/img/gallery/team2.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
    ...
    <div class="container-md p-2 mt-5 pb-5">
      <div class="row">
        <div class="col-md">
